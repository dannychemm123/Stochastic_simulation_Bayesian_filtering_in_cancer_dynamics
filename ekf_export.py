...
for _, row in clinical.iterrows():
    ...
    for t_idx, (t_months, t_days) in enumerate(zip(t_months_list, t_days_list)):
        ...
        all_results.append({
            ...
            'kalman_predicted_mm'  : round(pred_size, 2),
...
# Save results
results_df.to_csv('EKF_Export.csv', index=False)
print("\n✓ EKF_Export.csv saved (includes kalman_predicted_mm for chapter5_from_csv.py)")
