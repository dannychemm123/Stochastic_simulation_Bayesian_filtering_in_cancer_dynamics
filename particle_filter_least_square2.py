...
def run_patient(idx_row_tuple, params):
    ...
    patient_results = []
    for t_idx, (t_months, t_days) in enumerate(
            zip(timepoints_months, timepoints_days)):
...
results_df.to_csv('PF_Results_least_square.csv', index=False)
print("\n✓ PF_Results_least_square.csv saved")
